...
struct qt_meta_stringdata_VoronoiDialog_t {
    QByteArrayData data[4];
    char stringdata[62];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    offsetof(qt_meta_stringdata_VoronoiDialog_t, stringdata) + ofs \
        - idx * sizeof(QByteArrayData) \
    )
static const qt_meta_stringdata_VoronoiDialog_t qt_meta_stringdata_VoronoiDialog = {
    {
...
QT_MOC_LITERAL(3, 39, 21)
    ...
    "VoronoiDialog\0on_clear_button_clicked\0"
...
const QMetaObject VoronoiDialog::staticMetaObject = {
    { &CustomBlockDialog::staticMetaObject, qt_meta_stringdata_VoronoiDialog.data,
      qt_meta_data_VoronoiDialog,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_VoronoiDialog.stringdata))
