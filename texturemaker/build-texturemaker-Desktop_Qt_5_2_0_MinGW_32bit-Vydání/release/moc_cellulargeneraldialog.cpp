...
struct qt_meta_stringdata_CellularGeneralDialog_t {
    QByteArrayData data[5];
    char stringdata[94];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    offsetof(qt_meta_stringdata_CellularGeneralDialog_t, stringdata) + ofs \
        - idx * sizeof(QByteArrayData) \
    )
static const qt_meta_stringdata_CellularGeneralDialog_t qt_meta_stringdata_CellularGeneralDialog = {
    {
QT_MOC_LITERAL(0, 0, 21),
QT_MOC_LITERAL(1, 22, 23),
QT_MOC_LITERAL(2, 46, 0),
QT_MOC_LITERAL(3, 47, 23),
QT_MOC_LITERAL(4, 71, 21)
    },
    "CellularGeneralDialog\0on_clear_button_clicked\0"
    "\0on_game_of_life_clicked\0on_buttonBox_accepted\0"
};
...
const QMetaObject CellularGeneralDialog::staticMetaObject = {
    { &CustomBlockDialog::staticMetaObject, qt_meta_stringdata_CellularGeneralDialog.data,
      qt_meta_data_CellularGeneralDialog,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_CellularGeneralDialog.stringdata))
