...
struct qt_meta_stringdata_ColorTransitionDialog_t {
    QByteArrayData data[7];
    char stringdata[143];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    offsetof(qt_meta_stringdata_ColorTransitionDialog_t, stringdata) + ofs \
        - idx * sizeof(QByteArrayData) \
    )
static const qt_meta_stringdata_ColorTransitionDialog_t qt_meta_stringdata_ColorTransitionDialog = {
    {
...
QT_MOC_LITERAL(6, 115, 26)
    ...
    "ColorTransitionDialog\0on_delete_button_clicked\0"
    "\0on_add_button_clicked\0on_edit_button_clicked\0"
    "on_buttonBox_accepted\0on_change_position_clicked\0"
};
...
void ColorTransitionDialog::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 4: _t->on_change_position_clicked(); break;
        default: ;
        }
    }
    Q_UNUSED(_a);
...
const QMetaObject ColorTransitionDialog::staticMetaObject = {
    { &CustomBlockDialog::staticMetaObject, qt_meta_stringdata_ColorTransitionDialog.data,
      qt_meta_data_ColorTransitionDialog,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_ColorTransitionDialog.stringdata))
