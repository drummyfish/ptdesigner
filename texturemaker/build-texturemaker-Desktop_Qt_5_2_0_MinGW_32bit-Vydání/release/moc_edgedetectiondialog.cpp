...
struct qt_meta_stringdata_EdgeDetectionDialog_t {
    QByteArrayData data[3];
    char stringdata[44];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    offsetof(qt_meta_stringdata_EdgeDetectionDialog_t, stringdata) + ofs \
        - idx * sizeof(QByteArrayData) \
    )
static const qt_meta_stringdata_EdgeDetectionDialog_t qt_meta_stringdata_EdgeDetectionDialog = {
    {
QT_MOC_LITERAL(0, 0, 19),
QT_MOC_LITERAL(1, 20, 21),
QT_MOC_LITERAL(2, 42, 0)
    },
    "EdgeDetectionDialog\0on_buttonBox_accepted\0"
    "\0"
};
...
const QMetaObject EdgeDetectionDialog::staticMetaObject = {
    { &CustomBlockDialog::staticMetaObject, qt_meta_stringdata_EdgeDetectionDialog.data,
      qt_meta_data_EdgeDetectionDialog,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_EdgeDetectionDialog.stringdata))
