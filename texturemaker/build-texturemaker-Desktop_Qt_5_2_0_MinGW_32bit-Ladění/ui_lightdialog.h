...
public:
    ...
    void setupUi(QDialog *LightDialog)
    {
        ...
        set_preset->setObjectName(QStringLiteral("set_preset"));
    ...
    void retranslateUi(QDialog *LightDialog)
    {
        ...
        set_preset->setText(QApplication::translate("LightDialog", "set", 0));
        preset->clear();
        preset->insertItems(0, QStringList()
         << QApplication::translate("LightDialog", "gold", 0)
         << QApplication::translate("LightDialog", "copper", 0)
         << QApplication::translate("LightDialog", "blue metal", 0)
         << QApplication::translate("LightDialog", "dirt", 0)
         << QApplication::translate("LightDialog", "green plastic", 0)
        );
        label_8->setText(QApplication::translate("LightDialog", "presets", 0));
    } // retranslateUi
