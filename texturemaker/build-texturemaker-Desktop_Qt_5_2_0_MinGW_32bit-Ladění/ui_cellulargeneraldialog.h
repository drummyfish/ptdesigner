...
public:
    ...
    void setupUi(QDialog *CellularGeneralDialog)
    {
        ...
        CellularGeneralDialog->resize(600, 400);
        ...
        CellularGeneralDialog->setMinimumSize(QSize(600, 400));
        CellularGeneralDialog->setMaximumSize(QSize(600, 400));
        ...
        rules->setMinimumSize(QSize(420, 0));
