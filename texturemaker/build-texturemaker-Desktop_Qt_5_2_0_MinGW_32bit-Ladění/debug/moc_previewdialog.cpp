...
#include "../../texturemaker/previewdialog.h"
...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    offsetof(qt_meta_stringdata_PreviewDialog_t, stringdata) + ofs \
...
const QMetaObject PreviewDialog::staticMetaObject = {
    { &QDialog::staticMetaObject, qt_meta_stringdata_PreviewDialog.data,
      qt_meta_data_PreviewDialog,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_PreviewDialog.stringdata))
