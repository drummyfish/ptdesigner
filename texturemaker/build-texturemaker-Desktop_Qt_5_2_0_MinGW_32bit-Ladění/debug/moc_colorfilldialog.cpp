...
struct qt_meta_stringdata_ColorFillDialog_t {
    QByteArrayData data[4];
    char stringdata[56];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    offsetof(qt_meta_stringdata_ColorFillDialog_t, stringdata) + ofs \
        - idx * sizeof(QByteArrayData) \
    )
static const qt_meta_stringdata_ColorFillDialog_t qt_meta_stringdata_ColorFillDialog = {
    {
...
QT_MOC_LITERAL(3, 33, 21)
    ...
    "ColorFillDialog\0on_pick_clicked\0\0"
