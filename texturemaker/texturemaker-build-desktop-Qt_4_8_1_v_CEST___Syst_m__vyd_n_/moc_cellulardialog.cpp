...
static const char qt_meta_stringdata_CellularDialog[] = {
    "CellularDialog\0\0on_buttonBox_accepted()\0"
};
...
const QMetaObjectExtraData CellularDialog::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject CellularDialog::staticMetaObject = {
    { &CustomBlockDialog::staticMetaObject, qt_meta_stringdata_CellularDialog,
      qt_meta_data_CellularDialog, &staticMetaObjectExtraData }
};

#ifdef Q_NO_DATA_RELOCATION
const QMetaObject &CellularDialog::getStaticMetaObject() { return staticMetaObject; }
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_CellularDialog))
