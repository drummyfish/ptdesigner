...
public:
    ...
    void setupUi(QDialog *MosaicDialog)
    {
        if (MosaicDialog->objectName().isEmpty())
            MosaicDialog->setObjectName(QString::fromUtf8("MosaicDialog"));
        ...
        fill_type_combo->setObjectName(QString::fromUtf8("fill_type_combo"));

        gridLayout->addWidget(fill_type_combo, 21, 1, 1, 1);

        combo_1 = new QComboBox(MosaicDialog);
        combo_1->setObjectName(QString::fromUtf8("combo_1"));
        ...
        repeat_x->setObjectName(QString::fromUtf8("repeat_x"));
        ...
        repeat_y->setObjectName(QString::fromUtf8("repeat_y"));
        ...
        validity->setObjectName(QString::fromUtf8("validity"));
        ...
        point_edit_3->setObjectName(QString::fromUtf8("point_edit_3"));
        ...
        point_edit_4->setObjectName(QString::fromUtf8("point_edit_4"));
        ...
        point_edit_1->setObjectName(QString::fromUtf8("point_edit_1"));
    ...
    {
        MosaicDialog->setWindowTitle(QApplication::translate("MosaicDialog", "Dialog", 0, QApplication::UnicodeUTF8));
        label_8->setText(QApplication::translate("MosaicDialog", "fill colors", 0, QApplication::UnicodeUTF8));
        fill_type_combo->clear();
        fill_type_combo->insertItems(0, QStringList()
         << QApplication::translate("MosaicDialog", "none", 0, QApplication::UnicodeUTF8)
         << QApplication::translate("MosaicDialog", "keep borders", 0, QApplication::UnicodeUTF8)
         << QApplication::translate("MosaicDialog", "no borders", 0, QApplication::UnicodeUTF8)
        );
        combo_1->clear();
        combo_1->insertItems(0, QStringList()
         << QApplication::translate("MosaicDialog", "rotate around center", 0, QApplication::UnicodeUTF8)
         << QApplication::translate("MosaicDialog", "rotate around vertex", 0, QApplication::UnicodeUTF8)
         << QApplication::translate("MosaicDialog", "shift", 0, QApplication::UnicodeUTF8)
         << QApplication::translate("MosaicDialog", "shift and flip", 0, QApplication::UnicodeUTF8)
        );
        label_4->setText(QApplication::translate("MosaicDialog", "left", 0, QApplication::UnicodeUTF8));
        label->setText(QApplication::translate("MosaicDialog", "top", 0, QApplication::UnicodeUTF8));
        label_3->setText(QApplication::translate("MosaicDialog", "bottom", 0, QApplication::UnicodeUTF8));
        label_2->setText(QApplication::translate("MosaicDialog", "right", 0, QApplication::UnicodeUTF8));
        label_5->setText(QApplication::translate("MosaicDialog", "repeat horizontally", 0, QApplication::UnicodeUTF8));
        combo_2->clear();
        ...
        validity->setText(QApplication::translate("MosaicDialog", "validity", 0, QApplication::UnicodeUTF8));
        label_7->setText(QApplication::translate("MosaicDialog", "this specification is", 0, QApplication::UnicodeUTF8));
        label_9->setText(QApplication::translate("MosaicDialog", "fill type", 0, QApplication::UnicodeUTF8));
        label_6->setText(QApplication::translate("MosaicDialog", "repeat vertically", 0, QApplication::UnicodeUTF8));
        combo_3->clear();
        ...
        clear_1->setText(QApplication::translate("MosaicDialog", "clear", 0, QApplication::UnicodeUTF8));
        clear_2->setText(QApplication::translate("MosaicDialog", "clear", 0, QApplication::UnicodeUTF8));
        clear_3->setText(QApplication::translate("MosaicDialog", "clear", 0, QApplication::UnicodeUTF8));
        clear_4->setText(QApplication::translate("MosaicDialog", "clear", 0, QApplication::UnicodeUTF8));
    } // retranslateUi
