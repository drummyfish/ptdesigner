...
**
** Created: Mon Feb 24 13:34:23 2014
...
static const char qt_meta_stringdata_PerlinDialog[] = {
    "PerlinDialog\0\0value\0"
    "on_amplitude_slider_valueChanged(int)\0"
...
const QMetaObjectExtraData PerlinDialog::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject PerlinDialog::staticMetaObject = {
    { &CustomBlockDialog::staticMetaObject, qt_meta_stringdata_PerlinDialog,
      qt_meta_data_PerlinDialog, &staticMetaObjectExtraData }
};

#ifdef Q_NO_DATA_RELOCATION
const QMetaObject &PerlinDialog::getStaticMetaObject() { return staticMetaObject; }
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_PerlinDialog))
