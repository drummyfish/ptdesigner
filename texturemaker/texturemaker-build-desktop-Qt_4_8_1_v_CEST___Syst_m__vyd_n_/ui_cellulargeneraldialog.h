...
public:
    ...
    void setupUi(QDialog *CellularGeneralDialog)
    {
        if (CellularGeneralDialog->objectName().isEmpty())
            CellularGeneralDialog->setObjectName(QString::fromUtf8("CellularGeneralDialog"));
        ...
        frame->setStyleSheet(QString::fromUtf8("background-image: url(:/resources/cellular_general.png);"));
        ...
        game_of_life->setObjectName(QString::fromUtf8("game_of_life"));
    ...
    {
        CellularGeneralDialog->setWindowTitle(QApplication::translate("CellularGeneralDialog", "Dialog", 0, QApplication::UnicodeUTF8));
        label_2->setText(QApplication::translate("CellularGeneralDialog", "iterations", 0, QApplication::UnicodeUTF8));
        QTableWidgetItem *___qtablewidgetitem = rules->horizontalHeaderItem(0);
        ___qtablewidgetitem->setText(QApplication::translate("CellularGeneralDialog", "a", 0, QApplication::UnicodeUTF8));
        QTableWidgetItem *___qtablewidgetitem1 = rules->horizontalHeaderItem(1);
        ___qtablewidgetitem1->setText(QApplication::translate("CellularGeneralDialog", "b", 0, QApplication::UnicodeUTF8));
        QTableWidgetItem *___qtablewidgetitem2 = rules->horizontalHeaderItem(2);
        ___qtablewidgetitem2->setText(QApplication::translate("CellularGeneralDialog", "c", 0, QApplication::UnicodeUTF8));
        QTableWidgetItem *___qtablewidgetitem3 = rules->horizontalHeaderItem(3);
        ___qtablewidgetitem3->setText(QApplication::translate("CellularGeneralDialog", "d", 0, QApplication::UnicodeUTF8));
        QTableWidgetItem *___qtablewidgetitem4 = rules->horizontalHeaderItem(4);
        ___qtablewidgetitem4->setText(QApplication::translate("CellularGeneralDialog", "e", 0, QApplication::UnicodeUTF8));
        QTableWidgetItem *___qtablewidgetitem5 = rules->horizontalHeaderItem(5);
        ___qtablewidgetitem5->setText(QApplication::translate("CellularGeneralDialog", "f", 0, QApplication::UnicodeUTF8));
        QTableWidgetItem *___qtablewidgetitem6 = rules->horizontalHeaderItem(6);
        ___qtablewidgetitem6->setText(QApplication::translate("CellularGeneralDialog", "g", 0, QApplication::UnicodeUTF8));
        QTableWidgetItem *___qtablewidgetitem7 = rules->horizontalHeaderItem(7);
        ___qtablewidgetitem7->setText(QApplication::translate("CellularGeneralDialog", "h", 0, QApplication::UnicodeUTF8));
        QTableWidgetItem *___qtablewidgetitem8 = rules->horizontalHeaderItem(8);
        ___qtablewidgetitem8->setText(QApplication::translate("CellularGeneralDialog", "y", 0, QApplication::UnicodeUTF8));
        game_of_life->setText(QApplication::translate("CellularGeneralDialog", "game of life", 0, QApplication::UnicodeUTF8));
        label->setText(QApplication::translate("CellularGeneralDialog", "<html><head/><body><p>y:</p><p>1 - cell is born</p><p>0 - nothing happens</p><p>-1 - cell dies</p></body></html>", 0, QApplication::UnicodeUTF8));
        clear_button->setText(QApplication::translate("CellularGeneralDialog", "clear", 0, QApplication::UnicodeUTF8));
        label_3->setText(QApplication::translate("CellularGeneralDialog", "states", 0, QApplication::UnicodeUTF8));
    } // retranslateUi
